    ...
    return(
        <div className="aboutUS">
            ...
            <nav className="navbarAllPages">
                <ul>
                    <li><a href="../html/index.html"><span className="material-symbols-outlined">Home</span></a></li>
                ...
                <main>
                    ...
                    <div className="card">
                        <div className="card-body">
                            <h2 className="card-title"> About the Problem Space:</h2>
                            
                            <p className="card-text"> We want to design an app that creates a space for people to share, connect, and support each other through
                            ...
                            <p className="card-text"> An information technology problem in the space is the challenge with current social media apps.
                    ...
                    <div className="card">
                        <div className="card-body">
                            <h2 className="card-title"> About the App: </h2>
                                <p className="card-text">The users of MusicMatch are students at UW who use Spotify to listen to music, and are looking to
                                ...
                                <p className="card-text">One significant feature of MusicMatch is that users can upload music they are listening to, along with
                                ...
                                <p className="card-text"> Users will primarily be viewing a static map using a <a href="https://maps.googleapis.com/maps/api/js?key=YOUR_API_KEY_HERE&callback=initMap&libraries=&v=weekly">
                                ...
                                <p className="card-text">College students use music to accompany most everything they do, from studying to exercising to completing
                    ...
                    <section>
                        ...
                        <h3>This is a design for INFO 340 - Web Development.</h3>

                        <div className="card">
                            <div className="card-body">
                                <p className="card-title">Jasmine Losovsky</p>
                                <p className="card-text"> Lorem ipsum dolor sit amet. Qui odio sunt ut facilis voluptas sed rerum porro? Ea quae eius quo deserunt
                        ...
                        <div className="card">
                            <div className="card-body">
                                <p className="card-title">Kylah Moon</p>
                                <p className="card-text"> Lorem ipsum dolor sit amet. Qui odio sunt ut facilis voluptas sed rerum porro? Ea quae eius quo deserunt
                                recusandae quilaborum quia et consequatur repellendus At nesciunt quia cum nisi praesentium.</p>
                            </div>
                        </div>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <p className="card-title">Jessica Wang</p>
                                <p className="card-text"> Lorem ipsum dolor sit amet. Qui odio sunt ut facilis voluptas sed rerum porro? Ea quae eius quo deserunt
                                recusandae quilaborum quia et consequatur repellendus At nesciunt quia cum nisi praesentium.</p>
                            </div>
                        </div>
                        ...
                        <div className="card">
                            <div className="card-body">
                                <p className="card-title">Anu Ghosh</p>
                                <p className="card-text"> Lorem ipsum dolor sit amet. Qui odio sunt ut facilis voluptas sed rerum porro? Ea quae eius quo deserunt
                                recusandae quilaborum quia et consequatur repellendus At nesciunt quia cum nisi praesentium.</p>
                            </div>
                        </div>
